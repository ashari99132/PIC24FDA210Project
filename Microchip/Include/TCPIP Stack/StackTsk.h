...
//Split APP_CONFIG structure into its respective bytes
typedef union __APP_CONFIG_PagestructToByte__
{
  BYTE bytes[ sizeof( APP_CONFIG )];
  APP_CONFIG Page_Instance;
}APP_CONFIG_PAGESTRUCTTOBYTE, *pAPP_CONFIG_PAGESTRUCTTOBYTE;
