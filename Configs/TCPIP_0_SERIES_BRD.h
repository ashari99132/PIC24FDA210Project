...
#define STACK_USE_ICMP_SERVER			// Ping query and response capability : This allows others system in N/W to ping this IP
...
//This allocates an IP address to this board if connected to a DHCP enabled network.
 ...
 */
#define MY_DEFAULT_HOST_NAME			"O Series MB"
 ...
 */
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
			...
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 50, 20},
