...
//---------------------------------Splitting of Variables intp bytes-----------------------------------//
//Split an unsigned int into its respective bytes
typedef union __wordToByte__
{
  BYTE bytes[ sizeof( WORD )];
  WORD word;
}WORDTOBYTE, *pWORDTOBYTE;

//Split a float into its respective bytes
typedef union __floatToByte__
{
  BYTE bytes[ sizeof( FLOAT ) ];
  FLOAT float_data;
}FLOATTOBYTE, *pFLOATTOBYTE;

//Split an unsigned long into its respective bytes
typedef union __longToByte__
{
  BYTE bytes[ sizeof( LINT ) ];
  LINT long_data;
}LONGTOBYTE, *pLONGTOBYTE;


//Split an signed int into its respective bytes
typedef union __signedintToByte__
{
  BYTE bytes[ sizeof( SINT ) ];
  SINT signed_data;
}SIGNEDINTTOBYTE, *pSIGNEDINTTOBYTE;

//Split an signed short into its respective bytes
typedef union __signedshortToByte__
{
  BYTE bytes[ sizeof( SIGWORD ) ];
  SIGWORD signed_data;
}SIGNEDSHORTTOBYTE, *pSIGNEDSHORTTOBYTE;
//---------------------------------Splitting of Variables intp bytes-----------------------------------//
